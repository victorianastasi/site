...
let projects = [
    ...
    {nombre: "Rick and Morty", carouselId: "carouselRM", img1: "./img/rm1.jpg", img2: "./img/rm2.jpg", img3: "./img/rm3.jpg", descripcion: "Proyecto Rick and Morty, desarrollado con Javascript, utilizando API.", github:"https://github.com/victorianastasi/rickandmorty", online:"https://rickandmorty-vn.netlify.app/", links: 2},
    {nombre: "Movie App", carouselId: "carouselMA", img1: "./img/movies1.jpg", img2: "./img/movies2.jpg", img3: "./img/movies3.jpg", descripcion: "Sitio web responsive, desarrollado con Javascript y Semantic UI, donde se consume TMDB API", github:"https://github.com/victorianastasi/movieApp", online:"https://victorianastasi.github.io/movieApp/", links: 2}
];
